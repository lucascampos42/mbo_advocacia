...
<?php if (get_theme_mod('mbo_whatsapp_enable', true)) : ?>
<div id="whatsapp-float" class="whatsapp-float <?php echo esc_attr(get_theme_mod('mbo_whatsapp_position', 'bottom-right')); ?>">
    <a href="#" id="whatsapp-link" class="whatsapp-link" target="_blank" rel="noopener noreferrer">
        <div class="whatsapp-icon">
            <i class="fab fa-whatsapp"></i>
        </div>
        <span class="whatsapp-text"><?php echo esc_html(get_theme_mod('mbo_whatsapp_button_text', 'Fale Conosco')); ?></span>
    </a>
</div>
<?php endif; ?>
